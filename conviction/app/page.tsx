...
const PITCH_EN = [
  ...
  "Conviction is built around one restriction: at signup you pick exactly one coin (Bitcoin or a serious, established altcoin — no meme coins) and exactly one stance — do you want to keep seeing bullish-leaning coverage, or bearish/risk-leaning coverage?",
...
const PITCH_JA_FALLBACK = [
  ...
  "Conviction はたった一つの制約で成り立っています: 登録時にコインを1つだけ(ビットコインか、真面目で確立されたアルトコイン — ミームコインは対象外)、スタンスを1つだけ(強気寄りの報道を見続けたいか、弱気・警戒寄りの報道を見続けたいか)選びます。",
